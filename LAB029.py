...
birthday = SpecialCake('brithday', 'cake', 'chocolate', ['banan'],
                       'chocolate', 'brithday', 'oval', 'hearts', 'happy brithday')
wedding = SpecialCake('wedding', 'cake', 'chocolate', ['banan'],
                      'chocolate', 'wedding', 'oval', 'hearts', 'happy wedding')
